            ...
            <div class="Inner_container" >
                <div class="Projects" id="Projects">
                    ...
                    <h2 data-aos="fade-in" data-aos-duration="1000">Here is some of my recent work...</h2>
                                 ...
                                 <a><div data-aos="zoom-in" data-aos-duration="2000" class="container2">
                                    <img class="BookStore" src={require('../Images/UnderConstruction.png')} height={300} width={500} />
                                    <div class="overlay2">
                                        <div class="text"><h3>Website for Animal Clinic</h3>
                                            <b>Currently in progress</b></div>
                                    </div>
                                </div> </a>
